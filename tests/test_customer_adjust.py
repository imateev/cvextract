...
class TestFetchCustomerPage:
    ...
    def test_fetch_customer_page_success(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "cvextract.adjusters.openai_company_research_adjuster.requests",
            mock_requests,
        )
    ...
    def test_fetch_customer_page_no_requests_lib(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "cvextract.adjusters.openai_company_research_adjuster.requests", None
        )
...
class TestUrlToCacheFilename:
    """Tests for url_to_cache_filename helper."""

    def test_url_to_cache_filename_basic(self):
        """Test basic URL conversion."""
        result = url_to_cache_filename("https://example.com")
    ...
    def test_url_to_cache_filename_removes_protocol(self):
        ...
        result1 = url_to_cache_filename("https://example.com")
    ...
    def test_url_to_cache_filename_different_urls(self):
        ...
        result1 = url_to_cache_filename(url1)
        result2 = url_to_cache_filename(url2)
        assert result1 != result2
...
class TestLoadResearchSchema:
    ...
    def test_load_research_schema_success(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(
            "cvextract.adjusters.openai_company_research_adjuster._SCHEMA_PATH",
            schema_file,
        )
        monkeypatch.setattr(
            "cvextract.adjusters.openai_company_research_adjuster._RESEARCH_SCHEMA",
            None,
        )
...
class TestResearchCompanyProfile:
    ...
    def test_research_company_profile_openai_unavailable(self, caplog, monkeypatch):
        ...
        monkeypatch.setattr(
            "cvextract.adjusters.openai_company_research_adjuster.OpenAI", None
        )
    ...
    def test_research_company_profile_success(self, tmp_path, caplog, monkeypatch):
        ...
        research_data = {
            ...
            "technology_signals": [
                {"technology": "Python", "interest_level": "high", "confidence": 0.9}
            ],
        }
    ...
    def test_research_company_profile_with_acquisition_and_rebrand_data(
        ...
        research_data = {
            ...
            "acquisition_history": [
                {"owner": "BigTech Corp", "year": 2020, "notes": "Acquired for $100M"},
                {"owner": "StartupVentures", "year": 2015},
            ],
    ...
    def test_research_company_profile_with_products_data(
        self, tmp_path, caplog, monkeypatch
    ):
        ...
        research_data = {
            ...
            "owned_products": [
                ...
                {"name": "DataHub", "category": "software"},
            ],
            "used_products": [
                {
                    "name": "Salesforce",
    ...
    def test_research_company_profile_missing_required_fields(
...
class TestOpenAIRetryMethods:
    ...
    def test_sleep_with_backoff_write_multiplier(self, monkeypatch):
        ...
        config = _RetryConfig(
            deterministic=True, base_delay_s=1.0, write_multiplier=2.0
        )
        exc = Exception("Test")
...
class TestResearchCompanyProfileEdgeCases:
    ...
    def test_research_company_profile_cache_corruption_invalid_json(
    ...
    def test_research_company_profile_retry_call_uses_config(self, monkeypatch):
        ...
        result = _research_company_profile(
            "https://example.com", "test-key", "gpt-4o-mini", retry=custom_retry_config
        )
