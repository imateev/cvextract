...
def _write_docx_zip(path: Path, document_xml: str, headers: dict[str, str] | None = None) -> None:
    """
...
""".strip()
    ...
    hdr_xml = _hdr_xml([p_title, p_name, p_skills_languages, p_skills_item, p_languages_item])
