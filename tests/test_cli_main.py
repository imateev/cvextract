...
class TestMainFunction:
    ...
    def test_main_exception_without_debug(
        self, mock_gather, mock_prepare, mock_execute
    ):
    ...
    def test_main_exception_with_debug(
        self, mock_gather, mock_prepare, mock_execute, mock_log
    ):
    ...
    @patch("cvextract.cli.prepare_execution_environment")
    @patch("cvextract.cli.gather_user_requirements")
    def test_main_execute_returns_nonzero(
        self, mock_gather, mock_prepare, mock_execute
    ):
    ...
    @patch("cvextract.cli.prepare_execution_environment")
    @patch("cvextract.cli.gather_user_requirements")
    def test_main_exception_with_complex_error(
        self, mock_gather, mock_prepare, mock_execute, mock_log
    ):
