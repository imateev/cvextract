# Company Research & Caching (Merged)

## Notice

**This feature specification has been merged into the [Company Research Adjuster](../company-research-adjuster/README.md) spec.**

Company research and caching is now an integral part of the `OpenAICompanyResearchAdjuster` implementation in `cvextract/adjusters/openai_company_research_adjuster.py`.

## Status

**Merged** - See [Company Research Adjuster](../company-research-adjuster/README.md) for current documentation
...
are documented in the comprehensive [Company Research Adjuster](../company-research-adjuster/README.md) specification.
